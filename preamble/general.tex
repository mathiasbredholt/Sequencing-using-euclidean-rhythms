...
\let\newfloat\undefined
\usepackage[font=sf]{floatrow} % for ssf tables
...
\crefname{req}{design requirement}{design requirements} % ref for requirements
...
\newcommand{\tdr}[2][]{\todo[inline, color=red!40,#1]{#2}}
