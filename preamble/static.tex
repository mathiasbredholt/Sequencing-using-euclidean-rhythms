...
\def\thesisauthor  {Mathias Bredholt (s144040)\\Mathias Kirkegaard (s144032)}
\def\thesistitle   {Physical interaction with music software}
\def\thesissubtitle{Sequencing using euclidean rhythms}
